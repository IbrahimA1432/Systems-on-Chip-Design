...
module soc_system_mm_interconnect_0 (
	...
	wire          seg7_if_0_avalon_slave_agent_rdata_fifo_out_valid;          // SEG7_IF_0_avalon_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] seg7_if_0_avalon_slave_agent_rdata_fifo_out_data;           // SEG7_IF_0_avalon_slave_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          seg7_if_0_avalon_slave_agent_rdata_fifo_out_ready;          // avalon_st_adapter:in_0_ready -> SEG7_IF_0_avalon_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                              // avalon_st_adapter:out_0_valid -> SEG7_IF_0_avalon_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                               // avalon_st_adapter:out_0_data -> SEG7_IF_0_avalon_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                              // SEG7_IF_0_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                              // avalon_st_adapter:out_0_error -> SEG7_IF_0_avalon_slave_agent:rdata_fifo_sink_error
	...
	wire          switches_pio_s1_agent_rdata_fifo_out_valid;                 // switches_pio_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] switches_pio_s1_agent_rdata_fifo_out_data;                  // switches_pio_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          switches_pio_s1_agent_rdata_fifo_out_ready;                 // avalon_st_adapter_002:in_0_ready -> switches_pio_s1_agent_rdata_fifo:out_ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (SEG7_IF_0_clock_sink_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (seg7_if_0_avalon_slave_agent_rdata_fifo_out_data),       //     in_0.data
		.in_0_valid     (seg7_if_0_avalon_slave_agent_rdata_fifo_out_valid),      //         .valid
		.in_0_ready     (seg7_if_0_avalon_slave_agent_rdata_fifo_out_ready),      //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                          // in_clk_0.clk
		.in_rst_0_reset (SEG7_IF_0_clock_sink_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (switches_pio_s1_agent_rdata_fifo_out_data),              //     in_0.data
		.in_0_valid     (switches_pio_s1_agent_rdata_fifo_out_valid),             //         .valid
		.in_0_ready     (switches_pio_s1_agent_rdata_fifo_out_ready),             //         .ready
