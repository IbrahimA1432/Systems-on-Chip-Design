	soc_system u0 (
		...
		.alu_control_0_alu_control_a_start (<connected-to-alu_control_0_alu_control_a_start>), // alu_control_0_alu_control.a_start
		.alu_control_0_alu_control_a_reset (<connected-to-alu_control_0_alu_control_a_reset>), //                          .a_reset
		.alu_control_0_alu_control_a_done  (<connected-to-alu_control_0_alu_control_a_done>),  //                          .a_done
		.alu_data_0_alu_data_a_in1         (<connected-to-alu_data_0_alu_data_a_in1>),         //       alu_data_0_alu_data.a_in1
		.alu_data_0_alu_data_a_in2         (<connected-to-alu_data_0_alu_data_a_in2>),         //                          .a_in2
		.alu_data_0_alu_data_a_cfg         (<connected-to-alu_data_0_alu_data_a_cfg>),         //                          .a_cfg
		.alu_data_0_alu_data_a_result      (<connected-to-alu_data_0_alu_data_a_result>)       //                          .a_result
	);
