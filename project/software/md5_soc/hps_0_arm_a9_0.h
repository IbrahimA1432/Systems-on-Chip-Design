 ...
 * The macros are prefixed with 'MD5_CONTROL_SLAVE_0_'.
 * The prefix is the slave descriptor.
 */
#define MD5_CONTROL_SLAVE_0_COMPONENT_TYPE md5_control_slave
#define MD5_CONTROL_SLAVE_0_COMPONENT_NAME md5_control_slave_0
#define MD5_CONTROL_SLAVE_0_BASE 0xff200000
#define MD5_CONTROL_SLAVE_0_SPAN 16
#define MD5_CONTROL_SLAVE_0_END 0xff20000f

/*
 * Macros for device 'md5_data_slave_0', class 'md5_data_slave'
 * The macros are prefixed with 'MD5_DATA_SLAVE_0_'.
 * The prefix is the slave descriptor.
 */
#define MD5_DATA_SLAVE_0_COMPONENT_TYPE md5_data_slave
#define MD5_DATA_SLAVE_0_COMPONENT_NAME md5_data_slave_0
#define MD5_DATA_SLAVE_0_BASE 0xff200020
#define MD5_DATA_SLAVE_0_SPAN 32
#define MD5_DATA_SLAVE_0_END 0xff20003f
