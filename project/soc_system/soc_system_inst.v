	soc_system u0 (
		...
		.md5_control_slave_0_md5_control_m_start (<connected-to-md5_control_slave_0_md5_control_m_start>), // md5_control_slave_0_md5_control.m_start
		.md5_control_slave_0_md5_control_m_reset (<connected-to-md5_control_slave_0_md5_control_m_reset>), //                                .m_reset
		.md5_control_slave_0_md5_control_m_done  (<connected-to-md5_control_slave_0_md5_control_m_done>),  //                                .m_done
		.md5_data_slave_0_md5_data_m_writedata   (<connected-to-md5_data_slave_0_md5_data_m_writedata>),   //       md5_data_slave_0_md5_data.m_writedata
		.md5_data_slave_0_md5_data_m_writeaddr   (<connected-to-md5_data_slave_0_md5_data_m_writeaddr>),   //                                .m_writeaddr
		.md5_data_slave_0_md5_data_m_wr          (<connected-to-md5_data_slave_0_md5_data_m_wr>),          //                                .m_wr
		.md5_data_slave_0_md5_data_m_readaddr    (<connected-to-md5_data_slave_0_md5_data_m_readaddr>),    //                                .m_readaddr
		.md5_data_slave_0_md5_data_m_readdata    (<connected-to-md5_data_slave_0_md5_data_m_readdata>)     //                                .m_readdata
	);
